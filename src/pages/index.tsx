...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`AI IMAGER`}</title>

        <meta
          name="description"
          content="Empower Your Creativity with AI IMAGER: Transforming Text into Stunning Videos through the Power of Artificial Intelligence"
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Creativity with AI IMAGER: Transforming Text into Stunning Videos through the Power of Artificial Intelligence`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1655721530222-884d311f4b56?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyQ0FJfGVufDB8fHx8MTY4NzUwOTMzN3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
