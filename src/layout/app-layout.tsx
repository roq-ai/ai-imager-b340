...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'content-creator', 'video-editor', 'marketing-manager'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Text', path: '/texts', entity: 'text', service: AccessServiceEnum.PROJECT, icon: FiFileText },
